...
# generate_training_figure(["5m_vs_6m_rnn_qmix", "5m_vs_6m_rnn_qmix_ext", "5m_vs_6m_from-3m_rnn_qmix_direct", "5m_vs_6m_from-3m_rnn_qmix_unfreeze0.2", 
#                           "5m_vs_6m_from-8m_rnn_qmix_unfreeze0.2",
#                           "5m_vs_6m_from-25m_rnn_qmix_unfreeze0.2", "5m_vs_6m_from-5m_rnn_qmix_unfreeze0.2",
#                           ], label="tl_qmix/5m_vs_6m_rnn_qmix.png", only_last_legend=True)
...
#                           "6h_vs_8z_from-3s_rnn_qmix_direct"], label="tl_qmix/6h_vs_8z_rnn_qmix.png", only_last_legend=True)